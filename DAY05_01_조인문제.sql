...
SELECT * FROM EMPLOYEES E INNER JOIN DEPARTMENTS D ON E.DEPARTMENT_ID = D.DEPARTMENT_ID; -- 한개 유실 178번
...
WHERE E.FIRST_NAME ||' '|| E.LAST_NAME ='Steven King'; // AND 조건 사용
...
SELECT E1.FIRST_NAME ||' '|| E1.LAST_NAME 사원이름,
       E2.FIRST_NAME||' '||E2.LAST_NAME 담당매니저 

/*
VIEW는 제한적인 자료를 보기위해 사용하는 가상테이블 입니다.
...
--------------------------------------------------------------------------------
/*
VIEW를 통한 DML은 가능하긴 하지만, 몇 가지 제약사항이 있다.
1. 가상열 X
2. JOIN을 이용한 테이블인 경우에도 안됌
3. 원본테이블 NOT NULL제약이 있으면 안됌
*/
